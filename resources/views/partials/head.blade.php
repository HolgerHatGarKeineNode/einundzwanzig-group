...
{{-- P2 — NIP-52-Kalender: die Relays der Meetup-Termine (kind 31923) und der Zusagen
     ...
     **Auch diese zwei Zeilen stehen ZWEIMAL im Baum** — siehe die Begruendung beim
     Artikel-Block. `tests/Feature/CalendarRelaysTest.php` haelt beide zusammen; sie
     existiert, weil beim Bau von P2 genau dieser Fehler passiert ist: die Zeilen standen
     zuerst NUR im Paket-Partial, und die Terminkarte waere im normalen Web-Betrieb
     stumm auf dem HTTP-Rueckfallweg geblieben. --}}
