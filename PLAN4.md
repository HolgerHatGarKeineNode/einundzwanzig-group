...
2. **B1 ✅ → B2 ✅ → IMG ✅** (Bilder-Proxy) → **B4** (NIP-05, mittel, eigenständig) → **B5** (Head/OG, hängt an B1/B2) → **B3/B6** (Kür).
